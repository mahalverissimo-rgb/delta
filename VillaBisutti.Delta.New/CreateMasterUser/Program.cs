    ...
    public class Program
    {
        public static async Task<int> Main(string[] args)
        {
            try
            {
                ...
                builder.Services.AddDbContext<VillaBisutti.Delta.WebApp.Data.ApplicationDbContext>();
                builder.Services.AddIdentity<Usuario, IdentityRole>()
                    .AddEntityFrameworkStores<VillaBisutti.Delta.WebApp.Data.ApplicationDbContext>()
